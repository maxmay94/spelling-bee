      ...
      <div className='mx-auto mt-10 w-2/3 h-2/3 bg-gray-200/[0.3]'>
        <div className=' w-full h-full'>
          ...
          <div className='flex mt-14 w-1/3 mx-auto'>
            <button className='bg-gray-100 hover:bg-gray-200 rounded-3xl text-black p-3 px-5'>
              delete
            </button>
            <button className='flex-1 mx-20 bg-gray-100 hover:bg-gray-200 rounded-3xl text-black p-3 px-5'>
              ↺
            </button>
            <button className=' bg-gray-100 hover:bg-gray-200 rounded-3xl text-black p-3 px-5'>
              submit
